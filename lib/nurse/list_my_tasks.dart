...
class _ListMyTasksContainerState extends State<ListMyTasksContainer> {
  ...
  void fetchTasks() async {
    var url = Uri.parse('http://${server}:8000/tasks/my_tasks/');
                    ...
                    Column(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            if (myProfile!.type == 'Medic') {
                              await showDialog(
                                  context: context,
                                  builder: (BuildContext context) {
                                    return writeReport(context, task.patient!);
                                  });
                            }
                            var url = Uri.parse(
                                'http://${server}:8000/tasks/my_tasks/');
          ...
          Container(
            ...
            child: Column(
              children: [
                CircleAvatar(
                  backgroundImage: NetworkImage(
                      'http://$server:8000/users/profile_picture/${user.id}/'),
                  radius: 40,
                ),
                SizedBox(
                  height: 10,
